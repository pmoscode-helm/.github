---
title: PDG 6.01 - Released Helm Chart
---
...
Only if you follow this PDG to release a Helm Chart, the released Helm chart will be automatically added to
...
![Chart Releaser Action - Tag error](assets/PDG-6-1_chart_release_action_tag-error.png)
