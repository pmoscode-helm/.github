---
title: PDG 5.08 - Product Helm Chart
---
...
- name of the Chart **should** be just the `product-name` without prefix or suffix (similar to the [leading product repository](../PDG%202%20-%20GIT/PDG-2-4))
...
- [helm test](https://helm.sh/docs/helm/helm_test/) runs without errors (see [PDG 5.09 - Helm test](PDG-5-09))
