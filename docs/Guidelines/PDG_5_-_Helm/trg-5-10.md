---
title: PDG 5.10 - Kubernetes versions PRERELEASE
---
...
To do so you **must** create a GitHub action which runs helm test against all required kubernetes versions. See the following PDG for an example GitHub action: [Helm test](PDG-5-09.md).
