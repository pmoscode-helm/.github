---
title: PDG 5.02 - Chart structure
---
...
For further details about the Git repository structure, please refer to [PDG 2.03 - Repo
Structure](../PDG%202%20-%20GIT/PDG-2-3.md).
...
For best practices on `values.yaml` files, please refer to [PDG 5.05 - Chart Values](PDG-5-05.md) or [Helm
