---
title: PDG 5.11 - Upgradeability PRERELEASE
---
...
Based on the [Helm test](PDG-5-09.md) workflow, you **must** provide a GitHub action which takes the latest released helm chart, does an installation of it and then execute the upgrade to the current / new version.
