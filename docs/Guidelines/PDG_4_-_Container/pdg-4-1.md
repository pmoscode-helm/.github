...
Container image tagging also helps you to match [PDG 5.05 - Chart Values](../PDG_5_-_Helm/PDG-5-5.md#container-images).
...
!!! tip "Tip"
    Prefer annotated tags over lightweight tags. Refer to [Git documentation](https://git-scm.com/book/en/v2/Git-Basics-Tagging#_creating_tags) about tags.
...
4\. After the finishing the build workflow, your repository will contain proper versioned Docker images, e.g.:
   ...
   ![SemVer Docker images](assets/PDG4-1-semver-image.png)
