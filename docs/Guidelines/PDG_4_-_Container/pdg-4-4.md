---
title: PDG 4.05 - Container registries
---
...
Also be aware of the necessary remarks for container images described in [PDG 4-06](./PDG-4-06.md) and alignment on common base images
described in [PDG 4.02](./PDG-4-02.md).
